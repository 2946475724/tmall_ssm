            ...
            <table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
                <tr class="orderListItemFirstTR">
                    ...
                    <td colspan="2"><img width="13px"
                                         src="${pageContext.request.contextPath}/images/site/orderItemTmall.png">天猫商场
                    </td>
                    <td colspan="1">
                ...
                <c:forEach items="${o.orderItems}" var="oi" varStatus="st">
                    <tr class="orderItemProductInfoPartTR">
                        <td class="orderItemProductInfoPartTD"><img width="80" height="80"
                                                                    src="${pageContext.request.contextPath}/img/productSingle_middle/${oi.product.productImage.id}.jpg">
                        </td>
                        <td class="orderItemProductInfoPartTD">
                            <div class="orderListItemProductLinkOutDiv">
                                <a href="foreproduct?pid=${oi.product.id}">${oi.product.name}</a>
                                <div class="orderListItemProductLinkInnerDiv">
                                    <img src="${pageContext.request.contextPath}/images/site/creditcard.png"
                                         title="支持信用卡支付">
                                    <img src="${pageContext.request.contextPath}/images/site/7day.png"
