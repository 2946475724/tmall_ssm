    ...
    $(function () {
        ...
        $("img.cartProductItemIfSelected").click(function () {
            ...
            if ("selectit" === selectit) {
                $(this).attr("src", "${pageContext.request.contextPath}/images/site/cartNotSelected.png");
                $(this).attr("selectit", "false")
                $(this).parents("tr.cartProductItemTR").css("background-color", "#fff");
            }
            else {
                $(this).attr("src", "${pageContext.request.contextPath}/images/site/cartSelected.png");
        ...
        $("img.selectAllItem").click(function () {
            var selectit = $(this).attr("selectit")
            if ("selectit" === selectit) {
                $("img.selectAllItem").attr("src", "${pageContext.request.contextPath}/images/site/cartNotSelected.png");
                ...
                $("img.selectAllItem").attr("src", "${pageContext.request.contextPath}/images/site/cartSelected.png");
            ...
            <tr>
                <th class="selectAndImage">
                    <img selectit="false" class="selectAllItem"
                         src="${pageContext.request.contextPath}/images/site/cartNotSelected.png">
                    全选
                ...
                <tr oiid="${oi.id}" class="cartProductItemTR">
                    <td>
                        ...
                        <a style="display:none" href="#nowhere"><img
                                src="${pageContext.request.contextPath}/images/site/cartSelected.png"></a>
                        <img class="cartProductImg"
                             src="${pageContext.request.contextPath}/images/productSingle_middle/${oi.product.productImage.id}.jpg">
                    </td>
                    <td>
                        <div class="cartProductLinkOutDiv">
                            <a href="foreproduct?pid=${oi.product.id}" class="cartProductLink">${oi.product.name}</a>
                            <div class="cartProductLinkInnerDiv">
                                <img src="${pageContext.request.contextPath}/images/site/creditcard.png" title="支持信用卡支付">
                                <img src="${pageContext.request.contextPath}/images/site/7day.png" title="消费者保障服务,承诺7天退货">
                                <img src="${pageContext.request.contextPath}/images/site/promise.png"
