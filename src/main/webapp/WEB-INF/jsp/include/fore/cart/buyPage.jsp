...
<div class="buyPageDiv">
    <form action="forecreateOrder" method="post">
        ...
        <div class="buyFlow">
            <img class="pull-left" src="${pageContext.request.contextPath}/images/site/simpleLogo.png">
            <img class="pull-right" src="${pageContext.request.contextPath}/images/site/buyflow.png">
        ...
        <div class="productList">
            ...
            <table class="productListTable">
                ...
                <tr>
                    <th colspan="2" class="productListTableFirstColumn">
                        <img class="tmallbuy" src="${pageContext.request.contextPath}/images/site/tmallbuy.png">
            ...
            <div class="orderItemSumDiv">
                <div class="pull-left">
                    ...
                    <span>
                    <img class="leaveMessageImg" src="${pageContext.request.contextPath}/images/site/leaveMessage.png">
                </span>
